...
extern unsigned int mainTable[PAGE_SIZE];
extern unsigned int subTable1[PAGE_SIZE];
extern unsigned int subTable2[PAGE_SIZE];
extern unsigned int instructionTable[PAGE_SIZE];
extern unsigned int stackTable[PAGE_SIZE];
